...
import { STYTCH_INVESTOR_CLIENT } from '../../stytch/stytch.provider';
import { BaseAuthService } from '../../shared/auth/base-auth.service';

/**
 * Investor-specific authentication service using Investor Stytch project
 */
@Injectable()
export class InvestorAuthService extends BaseAuthService {
  constructor(
    @Inject(STYTCH_INVESTOR_CLIENT)
