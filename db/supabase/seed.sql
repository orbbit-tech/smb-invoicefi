...
('rel_tech_walmart', 'org_01tech', 'payer_01walmart', 12, 600000000000, 11, 1, 0, 91.67, NOW() - INTERVAL '365 days'),
('rel_tech_costco', 'org_01tech', 'payer_04costco', 5, 200000000000, 3, 1, 1, 60.00, NOW() - INTERVAL '200 days'),
('rel_food_target', 'org_02food', 'payer_02target', 8, 500000000000, 8, 0, 0, 100.00, NOW() - INTERVAL '180 days'),
('rel_retail_amazon', 'org_03retail', 'payer_03amazon', 3, 250000000000, 3, 0, 0, 100.00, NOW() - INTERVAL '60 days');
...
('inv_01settled', 'org_01tech', 'payer_01walmart', 50000000000, 365000, 60000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '80 days'))::BIGINT, EXTRACT(EPOCH FROM (NOW() - INTERVAL '20 days'))::BIGINT, 'SETTLED', 'SETTLED', 'INV-2024-001', 'LOW', NOW() - INTERVAL '80 days');

-- Invoice 2: FUNDED (Currently active, awaiting payment)
-- FoodDistrib → Target, $75k, 90 days, funded by Bob, due in 60 days
INSERT INTO invoice.invoice (id, organization_id, payer_company_id, amount, apr, discount_rate, invoice_date, due_at, lifecycle_status, on_chain_status, invoice_number, risk_score, created_at) VALUES
('inv_02funded', 'org_02food', 'payer_02target', 75000000000, 365000, 90000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '30 days'))::BIGINT, EXTRACT(EPOCH FROM (NOW() + INTERVAL '60 days'))::BIGINT, 'AWAITING_PAYMENT', 'FUNDED', 'INV-2024-002', 'LOW', NOW() - INTERVAL '35 days');

-- Invoice 3: LISTED (Available for funding on marketplace)
-- RetailWholesale → Amazon, $100k, 30 days, awaiting investor
INSERT INTO invoice.invoice (id, organization_id, payer_company_id, amount, apr, discount_rate, invoice_date, due_at, lifecycle_status, on_chain_status, invoice_number, risk_score, created_at) VALUES
('inv_03listed', 'org_03retail', 'payer_03amazon', 100000000000, 365000, 30000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '5 days'))::BIGINT, EXTRACT(EPOCH FROM (NOW() + INTERVAL '25 days'))::BIGINT, 'LISTED', 'LISTED', 'INV-2024-003', 'LOW', NOW() - INTERVAL '7 days');

-- Invoice 4: DEFAULTED (In collections workflow)
-- TechSupply → Costco, $40k, 60 days, funded by Charlie, defaulted after grace period
INSERT INTO invoice.invoice (id, organization_id, payer_company_id, amount, apr, discount_rate, invoice_date, due_at, lifecycle_status, on_chain_status, invoice_number, risk_score, created_at) VALUES
('inv_04defaulted', 'org_01tech', 'payer_04costco', 40000000000, 365000, 60000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '100 days'))::BIGINT, EXTRACT(EPOCH FROM (NOW() - INTERVAL '40 days'))::BIGINT, 'COLLECTION', 'DEFAULTED', 'INV-2024-004', 'MEDIUM', NOW() - INTERVAL '105 days');
...
('inv_05declined', 'org_02food', 'payer_02target', 200000000000, 365000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '15 days'))::BIGINT, EXTRACT(EPOCH FROM (NOW() + INTERVAL '75 days'))::BIGINT, 'DECLINED', 'INV-2024-005', 'HIGH', NOW() - INTERVAL '18 days');
...
('uw_01', 'inv_01settled', 'APPROVED', 'Strong payer credit (AAA), good payment history', 50000000000, 365000, 'LOW', 'PASSED', 'VERIFIED', EXTRACT(EPOCH FROM (NOW() - INTERVAL '78 days'))::BIGINT, NOW() - INTERVAL '78 days'),
('uw_02', 'inv_02funded', 'APPROVED', 'Excellent payer reliability, verified relationship', 75000000000, 365000, 'LOW', 'PASSED', 'VERIFIED', EXTRACT(EPOCH FROM (NOW() - INTERVAL '33 days'))::BIGINT, NOW() - INTERVAL '33 days'),
('uw_03', 'inv_03listed', 'APPROVED', 'AAA payer, strong SMB credentials', 100000000000, 365000, 'LOW', 'PASSED', 'VERIFIED', EXTRACT(EPOCH FROM (NOW() - INTERVAL '6 days'))::BIGINT, NOW() - INTERVAL '6 days'),
('uw_04', 'inv_04defaulted', 'APPROVED', 'Borderline approval, elevated risk', 40000000000, 365000, 'MEDIUM', 'PASSED', 'VERIFIED', EXTRACT(EPOCH FROM (NOW() - INTERVAL '103 days'))::BIGINT, NOW() - INTERVAL '103 days'),
...
('fund_01', 'inv_01settled', '0xaaaa111111111111111111111111111111111111', 50000000000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '75 days'))::BIGINT, '0xfund111111111111111111111111111111111111111111111111111111111111', '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913', 53000000000, 60000, NOW() - INTERVAL '75 days');

-- Invoice 2: Funded by Bob
INSERT INTO invoice.invoice_funding_detail (id, invoice_id, investor_address, funded_amount, funded_at, funding_tx_hash, payment_token_address, expected_repayment, expected_return, created_at) VALUES
('fund_02', 'inv_02funded', '0xbbbb222222222222222222222222222222222222', 75000000000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '30 days'))::BIGINT, '0xfund222222222222222222222222222222222222222222222222222222222222', '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913', 81750000000, 90000, NOW() - INTERVAL '30 days');

-- Invoice 4: Funded by Charlie (defaulted)
INSERT INTO invoice.invoice_funding_detail (id, invoice_id, investor_address, funded_amount, funded_at, funding_tx_hash, payment_token_address, expected_repayment, expected_return, created_at) VALUES
('fund_04', 'inv_04defaulted', '0xcccc333333333333333333333333333333333333', 40000000000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '95 days'))::BIGINT, '0xfund444444444444444444444444444444444444444444444444444444444444', '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913', 42400000000, 60000, NOW() - INTERVAL '95 days');
...
('nft_01', '0xfund111111111111111111111111111111111111111111111111111111111111', 'FUNDING', '0xaaaa111111111111111111111111111111111111', '0x1111111111111111111111111111111111111111', 50000000000, 12345100, EXTRACT(EPOCH FROM (NOW() - INTERVAL '75 days'))::BIGINT, 200000, 1000000000, 'CONFIRMED', NOW() - INTERVAL '75 days'),
('nft_01', '0xrepay11111111111111111111111111111111111111111111111111111111111', 'REPAYMENT', '0x1111111111111111111111111111111111111111', '0x5555555555555555555555555555555555555555', 53000000000, 12456789, EXTRACT(EPOCH FROM (NOW() - INTERVAL '20 days'))::BIGINT, 180000, 1000000000, 'CONFIRMED', NOW() - INTERVAL '20 days'),
('nft_01', '0xsettle1111111111111111111111111111111111111111111111111111111111', 'SETTLEMENT', '0x5555555555555555555555555555555555555555', '0xaaaa111111111111111111111111111111111111', 52100000000, 12457890, EXTRACT(EPOCH FROM (NOW() - INTERVAL '18 days'))::BIGINT, 170000, 1000000000, 'CONFIRMED', NOW() - INTERVAL '18 days'),
...
('nft_02', '0xfund222222222222222222222222222222222222222222222222222222222222', 'FUNDING', '0xbbbb222222222222222222222222222222222222', '0x2222222222222222222222222222222222222222', 75000000000, 12350100, EXTRACT(EPOCH FROM (NOW() - INTERVAL '30 days'))::BIGINT, 200000, 1000000000, 'CONFIRMED', NOW() - INTERVAL '30 days'),
...
('nft_04', '0xfund444444444444444444444444444444444444444444444444444444444444', 'FUNDING', '0xcccc333333333333333333333333333333333333', '0x1111111111111111111111111111111111111111', 40000000000, 12340100, EXTRACT(EPOCH FROM (NOW() - INTERVAL '95 days'))::BIGINT, 200000, 1000000000, 'CONFIRMED', NOW() - INTERVAL '95 days');
...
('autopay_01', 'inv_01settled', 'org_01tech', 'WALLET', true, '0x1111111111111111111111111111111111111111', 53000000000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '75 days'))::BIGINT, NOW() - INTERVAL '75 days'),
('autopay_02', 'inv_02funded', 'org_02food', 'WALLET', true, '0x2222222222222222222222222222222222222222', 81750000000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '30 days'))::BIGINT, NOW() - INTERVAL '30 days'),
('autopay_04', 'inv_04defaulted', 'org_01tech', 'WALLET', true, '0x1111111111111111111111111111111111111111', 42400000000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '95 days'))::BIGINT, NOW() - INTERVAL '95 days');
...
('InvoiceMinted', '0x5555555555555555555555555555555555555555', '0xmint111111111111111111111111111111111111111111111111111111111111', 12345001, EXTRACT(EPOCH FROM (NOW() - INTERVAL '77 days'))::BIGINT, 0, '1', '{"tokenId": "1", "issuer": "0x1111111111111111111111111111111111111111", "amount": "50000000000"}', true, NOW() - INTERVAL '77 days'),
('InvoiceFunded', '0x5555555555555555555555555555555555555555', '0xfund111111111111111111111111111111111111111111111111111111111111', 12345100, EXTRACT(EPOCH FROM (NOW() - INTERVAL '75 days'))::BIGINT, 1, '1', '{"tokenId": "1", "investor": "0xaaaa111111111111111111111111111111111111", "amount": "50000000000"}', true, NOW() - INTERVAL '75 days'),
('RepaymentDeposited', '0x5555555555555555555555555555555555555555', '0xrepay11111111111111111111111111111111111111111111111111111111111', 12456789, EXTRACT(EPOCH FROM (NOW() - INTERVAL '20 days'))::BIGINT, 2, '1', '{"tokenId": "1", "amount": "53000000000"}', true, NOW() - INTERVAL '20 days'),
('InvoiceRepaid', '0x5555555555555555555555555555555555555555', '0xsettle1111111111111111111111111111111111111111111111111111111111', 12457890, EXTRACT(EPOCH FROM (NOW() - INTERVAL '18 days'))::BIGINT, 3, '1', '{"tokenId": "1", "investor": "0xaaaa111111111111111111111111111111111111", "totalAmount": "52100000000"}', true, NOW() - INTERVAL '18 days'),
('InvoiceMinted', '0x5555555555555555555555555555555555555555', '0xmint222222222222222222222222222222222222222222222222222222222222', 12350001, EXTRACT(EPOCH FROM (NOW() - INTERVAL '32 days'))::BIGINT, 0, '2', '{"tokenId": "2", "issuer": "0x2222222222222222222222222222222222222222", "amount": "75000000000"}', true, NOW() - INTERVAL '32 days'),
('InvoiceFunded', '0x5555555555555555555555555555555555555555', '0xfund222222222222222222222222222222222222222222222222222222222222', 12350100, EXTRACT(EPOCH FROM (NOW() - INTERVAL '30 days'))::BIGINT, 1, '2', '{"tokenId": "2", "investor": "0xbbbb222222222222222222222222222222222222", "amount": "75000000000"}', true, NOW() - INTERVAL '30 days'),
('InvoiceMinted', '0x5555555555555555555555555555555555555555', '0xmint333333333333333333333333333333333333333333333333333333333333', 12460001, EXTRACT(EPOCH FROM (NOW() - INTERVAL '5 days'))::BIGINT, 0, '3', '{"tokenId": "3", "issuer": "0x3333333333333333333333333333333333333333", "amount": "100000000000"}', true, NOW() - INTERVAL '5 days'),
('InvoiceDefaulted', '0x5555555555555555555555555555555555555555', '0xdefault444444444444444444444444444444444444444444444444444444444', 12440000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '25 days'))::BIGINT, 0, '4', '{"tokenId": "4", "investor": "0xcccc333333333333333333333333333333333333", "principal": "40000000000"}', true, NOW() - INTERVAL '25 days');
...
('pos_01', 'user_01alice', 'inv_01settled', 'nft_01', 50000000000, 53000000000, 52100000000, 365000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '75 days'))::BIGINT, EXTRACT(EPOCH FROM (NOW() - INTERVAL '20 days'))::BIGINT, 'CLOSED', NOW() - INTERVAL '75 days'),
('pos_02', 'user_02bob', 'inv_02funded', 'nft_02', 75000000000, 81750000000, NULL, 365000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '30 days'))::BIGINT, EXTRACT(EPOCH FROM (NOW() + INTERVAL '60 days'))::BIGINT, 'ACTIVE', NOW() - INTERVAL '30 days'),
('pos_04', 'user_03charlie', 'inv_04defaulted', 'nft_04', 40000000000, 42400000000, 0, 365000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '95 days'))::BIGINT, EXTRACT(EPOCH FROM (NOW() - INTERVAL '40 days'))::BIGINT, 'DEFAULTED', NOW() - INTERVAL '95 days');
...
('yield_01', 'pos_01', 50000000000, 365000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '75 days'))::BIGINT, EXTRACT(EPOCH FROM (NOW() - INTERVAL '20 days'))::BIGINT, 55, 3000000000, 2100000000, 900000000, 300000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '75 days'))::BIGINT, NOW() - INTERVAL '75 days'),
('yield_02', 'pos_02', 75000000000, 365000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '30 days'))::BIGINT, EXTRACT(EPOCH FROM (NOW() + INTERVAL '60 days'))::BIGINT, 90, 6750000000, 4725000000, 2025000000, 300000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '30 days'))::BIGINT, NOW() - INTERVAL '30 days'),
('yield_04', 'pos_04', 40000000000, 365000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '95 days'))::BIGINT, EXTRACT(EPOCH FROM (NOW() - INTERVAL '40 days'))::BIGINT, 55, 2400000000, 1680000000, 720000000, 300000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '95 days'))::BIGINT, NOW() - INTERVAL '95 days');
...
('dist_01', 'pos_01', 'inv_01settled', '0xaaaa111111111111111111111111111111111111', 50000000000, 2100000000, 52100000000, EXTRACT(EPOCH FROM (NOW() - INTERVAL '18 days'))::BIGINT, '0xsettle1111111111111111111111111111111111111111111111111111111111', NOW() - INTERVAL '18 days');
